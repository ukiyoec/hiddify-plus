...
/// Integrates subscription_parser library for Clash, sing-box, V2Ray, and URI formats

class EnhancedProfileParser {
  ...
  List<ProxyNode> parseNodes(String content) {
    final parsed = ParserFactory.parse(content);
    return parsed.nodes;
  }

  String convertToFormat(List<ProxyNode> nodes, SubscriptionFormat targetFormat) {
  ...
  Future<ParsedSubscription> fetchAndParseSubscription(
    ...
    return _subscriptionService.fetchAndParse(url, headers: headers);
  }
}
