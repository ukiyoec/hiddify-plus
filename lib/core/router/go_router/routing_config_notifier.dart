...
import 'package:hiddify/features/settings/overview/sections/kernel/kernel_options_page.dart';
                ...
                GoRoute(
                  ...
                  routes: <GoRoute>[
                    GoRoute(
                      ...
                      path: '/kernel-options',
                      pageBuilder: (_, state) =>
                          customTransition(TransitionType.slide, state.pageKey, const KernelOptionsPage()),
                    ),
                    GoRoute(
                      name: 'general',
                      path: '/general',
